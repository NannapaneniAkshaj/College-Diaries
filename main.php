            ...
            <div class="collapse navbar-collapse" id="menu">
              ...
              <ul class="navbar-nav">
                ...
                <li class="nav-item" style="color: white;margin-left: 50px;">
                  <a href="write.php" class="nav-link" style="color: white;font-size: 25px;">Write
                  </a>
                </li>

     
                <li class="nav-item">
                  <a href="readn.php" class="nav-link" style="color: white;font-size: 25px;margin-left: 50px;">Read</a>
                </li>
              </ul>
            </div>
          </nav>
