  ...
  <section class="container-fluid">
    <section class="row justify-content-center">
      <section class="col-12 col-sm-6 col-md-3">
        ...
        <div class="login">
        	<h2>LOGIN</h2>
          <form name="login" id="captcha_form" action="validate.php" onsubmit="return validate()" method="post">

            <div class="input-box">
              <span><i class="fa fa-user icon fa-lg"></i></span>
              <input type="text" name="uname" placeholder="USERNAME" style="border-radius: 6px; border: 1px;box-shadow: 0 0 20px 0 black;font-size: 15px;width: 550px;">
            ...
            <center>
              ...
              <br>
              <a href="forgotPassword.php" style="font-size: 15px;">Forgot Password?</a>
              <br>
              <a href="signup.php" style="font-size: 15px;">Click here to Sign Up</a>
          </div>
          </center>
        </form>
      </section>
